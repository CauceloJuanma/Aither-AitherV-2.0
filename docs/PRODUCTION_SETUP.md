...
```bash
NEXT_PUBLIC_FIREBASE_API_KEY=AIzaSyCbQhJU-paYeKjqZK1BJGHZKgtSCbBLxpM
NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN=aitherproyect-36239.firebaseapp.com
NEXT_PUBLIC_FIREBASE_PROJECT_ID=aitherproyect-36239
NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET=aitherproyect-36239.appspot.com
NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID=378914491161
NEXT_PUBLIC_FIREBASE_APP_ID=1:378914491161:web:0ad09d79ca3134e4549388
```

### Variables privadas (solo servidor)

```bash
FIREBASE_ADMIN_CLIENT_EMAIL=firebase-adminsdk-fbsvc@aitherproyect-36239.iam.gserviceaccount.com
